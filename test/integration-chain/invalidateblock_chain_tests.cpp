...
public:
    ...
    uint256 MineBlock() {
        ...
        CBlockHeader header; header.nVersion=1; header.hashPrevBlock=tip->GetBlockHash(); header.payloadRoot=uint160(); header.nTime=tip->nTime+120; header.nBits=0x207fffff; header.nNonce=tip->nHeight+1;
